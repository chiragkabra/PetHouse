                ...
                <div class="card-body">
                    ...
                    <form method="post" action="{{route('create')}}" enctype="multipart/form-data">
                        ...
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4 @error('email') is-invalid @enderror" type="text" name="email">
                                </div>
                                @error('email')
                                <div style="color:red;">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4 @error('password') is-invalid @enderror" type="text" name="password">
                                </div>
                                @error('password')
                                <div style="color:red;">{{ $message }}</div>
                                    @enderror
                        ...
                        <div class="input-group">
                            ...
                            <div class="rs-select2 js-select-simple select--no-search @error('role ') is-invalid @enderror">
                         ...
                         <div class="input-group">
                            ...
                            <div class="rs-select2 js-select-simple select--no-search">
                                <input class="input--style-4 @error('image') is-invalid @enderror" type="file" name="image">
                                {{-- <select name="subject">
                                    <option disabled="disabled" selected="selected">Choose option</option>
                        ...
                        <div class="p-t-15">
                            <input type="submit" class="btn btn--radius-2 btn--blue" value="submit" name="register">
